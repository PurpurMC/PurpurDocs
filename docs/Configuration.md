...
* use-permissions-for-rows
    - **default**: false
    - **description**: Use permission nodes to determine the number of rows. Default row number is six. Apply lower permission to limit them. `six-rows` MUST be enabled for this to work.
